...
<style>
  ...
  /* ==========================================
     BLOQUE 6: SECCIÓN DE CONTACTO ESTILO PREMIUM (image_859dd8.png)
     ========================================== */
  .contact-section {
    padding: 6rem 10%;
    background-color: var(--bg-secondary);
  ...
  /* Contenedor de Redes Sociales (Fila Superior) */
  .contact-social-row {
    display: flex;
    justify-content: center;
    gap: 1.2rem;
  ...
  /* Ajuste de tarjetas simétricas idénticas a la captura del usuario */
  .contact-icon-card {
    display: flex;
    align-items: center;
    justify-content: center;
  ...
  /* Colores sutiles de enfoque de marca en hover */
  ...
  /* Fila Inferior Centrada para el Correo Corporativo */
  .contact-email-row {
    display: flex;
    justify-content: center;
    width: 100%;
